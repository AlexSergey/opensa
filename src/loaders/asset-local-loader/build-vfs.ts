 ...
 */
import type { Entry, ModelRef } from '../../game-build/partition';
import type { LazyImgArchive } from './img-reader';

import { ideRefs, partitionEntries, placedModels } from '../../game-build/partition';
import { parseBinaryIpl } from '../../renderware/parsers/text/ipl-binary.parser';
import { parseIpl } from '../../renderware/parsers/text/ipl.parser';
